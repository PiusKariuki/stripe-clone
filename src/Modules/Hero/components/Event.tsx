...
const Event = () => {
	return (
		<div
			className="flex bg-[#121252]/[.3] w-[250px] md:w-[365px] py-2 md:py-[4px]  rounded
         md:rounded-2xl text-white  text-[13px] md:text-[13px] font-semibold justify-center items-center
         group">
			<p className="px-2">
				Event
