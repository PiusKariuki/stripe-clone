...
const Started = () => {
  return (
		<div
			className="flex flex-col lg:flex-row z-10 bg-white w-full h-full -mt-[350px] md:-mt-[250px]
         gap-y-6 gap-x-6 pt-[121px] pb-[100px] relative">
			<div
				className="flex absolute w-[300vw] h-full 5xl:h-[135%] -z-50
            bg-white  -left-[100vw] top-1/2 -translate-y-1/2"
			/>
