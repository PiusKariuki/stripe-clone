...
const Topbar = () => {
	...
	return (
		<div
         ...
         pt-8 px-8 pb-3 lg:pt-[10.3px] lg:px-[150px] 2xl:px-[200px]">
			<div className={styles.gradient} />
			<FontAwesomeIcon icon={faStripe} color="white" className="flex text-5xl" />
			<button onClick={() => setOpen(true)} className="flex lg:hidden sign-btn justify-end">
