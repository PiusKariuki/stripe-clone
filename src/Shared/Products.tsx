...
export const products = [
	{
		...
		icon: (
			<svg
				...
				<g clipPath="url(#product-icon-atlas-SiteMobileMenu-a)">
					<path
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-billing-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-billing-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-billing-SiteMobileMenu-a"
						x1="13"
						y1="6.35"
						x2="13"
						y2="35.03"
					...
					<linearGradient
						id="product-icon-billing-SiteMobileMenu-b"
						x1="19.5"
						y1="12.01"
						x2="19.5"
						y2="30.19"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-capital-SiteMobileMenu-a)"></path>
				<path
					d="M36.85.05l-21.82 4.6A2.57 2.57 0 0 0 13 7.15V40h24.46c1.42-.2 2.54-1.3 2.54-2.7V2.55c0-1.6-1.52-2.8-3.15-2.5z"
					fill="url(#product-icon-capital-SiteMobileMenu-b)"></path>
				<path
					d="M23.95 14.05c1.63-.3 3.05.9 3.05 2.52V40H13V16.42l1.21-.25 9.74-2.12z"
					fill="url(#product-icon-capital-SiteMobileMenu-c)"></path>
				<defs>
					<linearGradient
						id="product-icon-capital-SiteMobileMenu-a"
						x1="13.52"
						y1="36.35"
						x2="13.52"
						y2="18.21"
					...
					<linearGradient
						id="product-icon-capital-SiteMobileMenu-b"
						x1="26.46"
						x2="26.46"
						y2="40"
						gradientUnits="userSpaceOnUse">
					...
					<linearGradient
						id="product-icon-capital-SiteMobileMenu-c"
						x1="19.93"
						y1="40"
						x2="19.93"
						y2="14"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-checkout-SiteMobileMenu-a)"></path>
				<path
					...
					fill="url(#product-icon-checkout-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-checkout-SiteMobileMenu-a"
						x1="16.01"
						y1="35.59"
						x2="16.01"
						y2="21.16"
					...
					<linearGradient
						id="product-icon-checkout-SiteMobileMenu-b"
						x1="21.07"
						y1="43"
						x2="21.07"
						y2="14.5"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-climate-SiteMobileMenu-a)"></path>
				<path
					...
					fill="url(#product-icon-climate-SiteMobileMenu-b)"></path>
				<path
					...
					fill="url(#product-icon-climate-SiteMobileMenu-c)"></path>
				<defs>
					<linearGradient
						id="product-icon-climate-SiteMobileMenu-a"
						x1="20"
						y1="20.63"
						x2="20"
						y2="9.57"
					...
					<linearGradient
						id="product-icon-climate-SiteMobileMenu-b"
						x1="20"
						y1="9.56"
						x2="20"
						y2="21.9"
					...
					<linearGradient
						id="product-icon-climate-SiteMobileMenu-c"
						x1="20"
						y1="35.28"
						x2="20"
						y2="15.28"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-connect-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-connect-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-connect-SiteMobileMenu-a"
						x1="13"
						y1="1.71"
						x2="13"
						y2="15.25"
					...
					<linearGradient
						id="product-icon-connect-SiteMobileMenu-b"
						x1="20"
						y1="15.72"
						x2="20"
						y2="27.24"
	...
	},
	{
		...
		icon: (
			<svg
				className="ProductIcon ProductIcon--CorporateCard "
				width="40"
				height="40"
				viewBox="0 0 40 40"
				fill="none"
				xmlns="http://www.w3.org/2000/svg">
				<title>Corporate Card logo</title>
				<g clipPath="url(#product-icon-corporate-SiteMobileMenu-card-a)">
					<path
						d="M32.94 19.84l-.56-2.6-.12-.57-2.73-12.7a2.47 2.47 0 0 0-1.09-1.57 2.52 2.52 0 0 0-1.89-.34L2 7.22A2.5 2.5 0 0 0 .4 8.3a2.46 2.46 0 0 0-.34 1.87l3.42 15.87a2.51 2.51 0 0 0 2.96 1.9l3.31-.68v-.54.55L31 22.8a2.5 2.5 0 0 0 1.6-1.07c.37-.56.49-1.24.34-1.89z"
						fill="url(#product-icon-corporate-SiteMobileMenu-card-b)"></path>
					<path
						d="M37.5 17h-25c-.66 0-1.3.27-1.77.75a2.62 2.62 0 0 0-.73 1.83v16.84A2.54 2.54 0 0 0 12.5 39h25c1.38 0 2.5-1.15 2.5-2.58V19.58c0-.69-.26-1.34-.73-1.83A2.46 2.46 0 0 0 37.5 17z"
						fill="#0073E6"></path>
					<path
						d="M32.33 17l.05.23.56 2.61A2.5 2.5 0 0 1 31 22.8l-21 4.42v-7.64c0-.62.21-1.21.6-1.68l.13-.15c.47-.48 1.1-.75 1.77-.75h19.83z"
						fill="url(#product-icon-corporate-SiteMobileMenu-card-c)"></path>
				</g>
				<defs>
					<linearGradient
						id="product-icon-corporate-SiteMobileMenu-card-b"
						x1="16.5"
						y1="-.25"
						x2="16.5"
						y2="31.55"
						gradientUnits="userSpaceOnUse">
						<stop offset=".18" stopColor="#FF80FF"></stop>
						<stop offset=".82" stopColor="#FF62DC"></stop>
					</linearGradient>
					<linearGradient
						id="product-icon-corporate-SiteMobileMenu-card-c"
						x1="11.92"
						y1="17"
						x2="11.92"
						y2="28"
					...
					<clipPath id="product-icon-corporate-SiteMobileMenu-card-a">
						<path fill="#fff" d="M0 0h40v40H0z"></path>
					</clipPath>
				</defs>
			</svg>
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-elements-SiteMobileMenu-a)"></path>
				<path
					fillRule="evenodd"
					clipRule="evenodd"
				...
				<path
					...
					fill="url(#product-icon-elements-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-elements-SiteMobileMenu-a"
						x1="17.41"
						y1="2.24"
						x2="17"
						y2="32.18"
					...
					<linearGradient
						id="product-icon-elements-SiteMobileMenu-b"
						x1="21.95"
						y1="40.81"
						x2="30.59"
						y2="9.56"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-identity-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-identity-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-identity-SiteMobileMenu-a"
						x1="23.65"
						y1="2.99"
						x2="23.65"
						y2="37"
					...
					<linearGradient
						id="product-icon-identity-SiteMobileMenu-b"
						x1="19.31"
						y1="19"
						x2="19.31"
						y2="37"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-invoicing-SiteMobileMenu-a)"></path>
				<path
					...
					fill="url(#product-icon-invoicing-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-invoicing-SiteMobileMenu-a"
						x1="17.3897"
						y1="20.25"
						x2="17.3893"
						y2="38"
					...
					<linearGradient
						id="product-icon-invoicing-SiteMobileMenu-b"
						x1="21.5889"
						y1="12.7122"
						x2="21.5881"
						y2="38.6633"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-issuing-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-issuing-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-issuing-SiteMobileMenu-a"
						x1="22.92"
						y1="11.68"
						x2="22.92"
						y2="39.68"
					...
					<linearGradient
						id="product-icon-issuing-SiteMobileMenu-b"
						x1="31.38"
						y1="27.93"
						x2="11.62"
						y2="27.93"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-payments-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-payments-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-payments-SiteMobileMenu-a"
						x1="20"
						y1="4.13"
						x2="20"
						y2="21.13"
					...
					<linearGradient
						id="product-icon-payments-SiteMobileMenu-b"
						x1="35"
						y1="11.28"
						x2="35"
						y2="28.72"
	...
	},
	{
		...
		icon: (
			<svg
				...
				<path
					fill="#96F"
					d="M10.001 9c-.70498 0-1.18863.70984-.93069 1.3659l2.85759 7.2682c.0925.2352.0925.4966 0 .7318l-2.85759 7.2682C8.81237 26.2902 9.29602 27 10.001 27h16.6311c.8222 0 1.5605-.5031 1.8613-1.2682l2.7522-7c.1849-.4703.1849-.9933 0-1.4636l-2.7522-7C28.1926 9.50309 27.4543 9 26.6321 9H10.001z"></path>
				<path
					fill="#0048E5"
					d="M22.3843 9c0 .24831-.0463.49663-.1387.7318l-2.7522 7C19.1926 17.4969 18.4543 18 17.6321 18h-5.6349c0-.1242-.0231-.2483-.0693-.3659l-2.85759-7.2682C8.81237 9.70984 9.29602 9 10.001 9h12.3833z"></path>
				<path
				...
				<defs>
					<linearGradient
						...
						y2="18.0004"
						gradientUnits="userSpaceOnUse">
						<stop offset=".225577" stopColor="#11EFE3"></stop>
						<stop offset="1" stopColor="#21CFE0"></stop>
					</linearGradient>
					<radialGradient
						...
						gradientUnits="userSpaceOnUse">
						<stop offset=".09375" stopColor="#fff"></stop>
					...
					<linearGradient
						...
						<stop offset="1" stopColor="#96F" stopOpacity="0"></stop>
					</linearGradient>
				</defs>
			</svg>
		),
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-radar-SiteMobileMenu-a)"></path>
				<path
					...
					fill="url(#product-icon-radar-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-radar-SiteMobileMenu-a"
						x1="13.98"
						y1="4.24"
						x2="13.98"
						y2="33.03"
					...
					<linearGradient
						id="product-icon-radar-SiteMobileMenu-b"
						x1="15.68"
						y1="10.48"
						x2="15.68"
						y2="33.03"
	...
	},
	{
		...
		icon: (
			<svg
				...
				fill="none"
				xmlns="http://www.w3.org/2000/svg">
				<title>Revenue Recognition logo</title>
				<path
					...
					fill="url(#product-icon-revrec-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-revrec-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-revrec-SiteMobileMenu-a"
						x1="13.7647"
						y1="1"
						x2="13.7647"
						y2="22.3532"
					...
					<linearGradient
						id="product-icon-revrec-SiteMobileMenu-b"
						x1="16.0302"
						y1="22.3652"
						x2="24.2719"
						y2="6.84356"
		...
		icon: (
			<svg
				...
				<defs>
					...
					<linearGradient
						id="product-icon-sigma-SiteMobileMenu-b"
						x1="20.28"
						y1="8.42"
						x2="20.28"
						y2="19.47"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-tax-SiteMobileMenu-a)"></path>
				<circle
					cx="17.6666"
					cy="24.3334"
				...
				<path
					...
					fill="url(#product-icon-tax-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-tax-SiteMobileMenu-a"
						x1="27.6927"
						y1="-.106484"
						x2="27.6927"
						y2="20.5734"
					...
					<linearGradient
						id="product-icon-tax-SiteMobileMenu-b"
						x1="23.3061"
						y1="24.96"
						x2="18.8407"
						y2="7.43349"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-terminal-SiteMobileMenu-a)"></path>
				<path
					d="M31 15.34V27.5c0 1.38-1.15 2.5-2.58 2.5H11.58A2.54 2.54 0 0 1 9 27.5v-7.43l.33-.07 21.34-4.59.33-.07z"
					fill="url(#product-icon-terminal-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-terminal-SiteMobileMenu-a"
						x1="20"
						y1="1.97"
						x2="20"
						y2="17.6"
					...
					<linearGradient
						id="product-icon-terminal-SiteMobileMenu-b"
						x1="31"
						y1="22.67"
						x2="5.34"
						y2="22.67"
		...
		icon: (
			<svg
				...
				<path
					...
					fill="url(#product-icon-banking-SiteMobileMenu-a)"></path>
				<path
				...
				<path
					...
					fill="url(#product-icon-banking-SiteMobileMenu-b)"></path>
				<defs>
					<linearGradient
						id="product-icon-banking-SiteMobileMenu-a"
						x1="14.5"
						y1="6.13"
						x2="14.5"
						y2="28.22"
					...
					<linearGradient
						id="product-icon-banking-SiteMobileMenu-b"
						x1="25.31"
						y1="29.5"
						x2="25.31"
						y2="9"
