...
export const uses = [
	...
	},
	{
		...
		icon: (
			<svg
				...
				xmlns="http://www.w3.org/2000/svg">
				<path
					d="M8.0004 0h-.0008C5.2388 0 3 2.2388 3 4.9998c0 1.381.5594 2.6308 1.4648 3.5358.702.7028 1.1472 1.5618 1.3436 2.4644h4.3838c.196-.9028.6412-1.7618 1.343-2.4644C12.4406 7.6306 13 6.3808 13 4.9998 13 2.2388 10.7614 0 8.0004 0ZM6.5862 6.4142 5.5254 7.4754c-1.3668-1.367-1.3668-3.5832 0-4.9504l1.0608 1.0608c-.7814.7812-.7812 2.0474 0 2.8284ZM10.0707 12.5H5.92871v1.429c-.0002 1.1436.9266 2.071 2.071 2.071 1.1434 0 2.07079-.9274 2.07079-2.071l.0002-1.429Z"
					fill="#88add2"></path>
			</svg>
		),
		description: "Startup Incoporation",
		...
		icon: (
			<svg
				...
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M12.915 1.845H2.30625C2.05151 1.845 1.845 2.05151 1.845 2.30625V3.22875C1.845 3.48349 2.05151 3.69 2.30625 3.69H13.8375C14.347 3.69 14.76 4.10302 14.76 4.6125V11.07C14.76 12.089 13.934 12.915 12.915 12.915H1.845C0.826035 12.915 0 12.089 0 11.07V1.845C0 0.826035 0.826035 0 1.845 0H12.915C13.4245 0 13.8375 0.413017 13.8375 0.9225C13.8375 1.43198 13.4245 1.845 12.915 1.845ZM11.07 7.38C10.5605 7.38 10.1475 7.79302 10.1475 8.3025C10.1475 8.81198 10.5605 9.225 11.07 9.225H11.9925C12.502 9.225 12.915 8.81198 12.915 8.3025C12.915 7.79302 12.502 7.38 11.9925 7.38H11.07Z"
					fill="#88add2"></path>
			</svg>
		),
		description: "Startup Incoporation",
		...
		icon: (
			<svg
				...
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M3 1a1 1 0 0 1 2 0v1H3V1zm10 1h1a2 2 0 0 1 2 2v2H0V4c0-1.1.9-2 2-2h1v1a1 1 0 0 0 2 0V2h6v1a1 1 0 1 0 2 0V2zm0 0h-2V1a1 1 0 1 1 2 0v1zm3 6H0v6c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8z"
					fill="#88add2"></path>
			</svg>
		),
		description: "Startup Incoporation",
	...
	},
	{
		...
		icon: (
			<svg
				className="ProductIcon text-[#88add2]"
				width="16"
				height="16"
				viewBox="0 0 16 16"
				xmlns="http://www.w3.org/2000/svg">
				<g fill="#88add2" fillRule="nonzero">
					<path d="M8.9 13.48a5.35 5.35 0 0 1-6.19.5l-2.48.82c-.18.06-.27-.03-.21-.2l.83-2.5A5.37 5.37 0 0 1 5.16 4a6.21 6.21 0 0 0 3.74 9.48z"></path>
					<path d="M14.98 10.12a5.37 5.37 0 1 0-1.86 1.86l2.48.83c.18.06.27-.03.21-.2l-.83-2.5z"></path>
				</g>
			</svg>
		),
		description: "Startup Incoporation",
